(async function bootUltimateClipboardProRealDemo() {
  ...
  function preloadManager(language = "en") {
    ...
    managerFrame.src = `${runtimeBase}demo-sidepanel.html?v=20260823-demo-guard-v1&lang=${encodeURIComponent(language)}&tab=text`;
  ...
  try {
    ...
    if (requestedLanguage !== "en") {
      await loadScript(`${runtimeBase}demo-locales/${requestedLanguage}.js?v=20260823-demo-guard-v1`);
    }
    await loadScript(`${runtimeBase}demo-runtime.js?v=20260823-demo-guard-v1`);
    ...
    await window.UCP_DEMO_RUNTIME.loadScript(`${runtimeBase}content/contentScript.js?v=20260823-demo-guard-v1`);
