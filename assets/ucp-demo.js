(async function bootUltimateClipboardProRealDemo() {
  ...
  function preloadManager(language = "en") {
    ...
    managerFrame.src = `${runtimeBase}demo-sidepanel.html?v=20260822-code-syntax-v3&lang=${encodeURIComponent(language)}&tab=text`;
  ...
  try {
    ...
    if (requestedLanguage !== "en") {
      await loadScript(`${runtimeBase}demo-locales/${requestedLanguage}.js?v=20260822-code-syntax-v3`);
    }
    await loadScript(`${runtimeBase}demo-runtime.js?v=20260822-code-syntax-v3`);
    ...
    await window.UCP_DEMO_RUNTIME.loadScript(`${runtimeBase}content/contentScript.js?v=20260822-code-syntax-v3`);
