...
const langs = {
  en: {
    ...
    heroTitle: "Meet someone unexpected. Stay private. Keep control.",
    ...
    sectionsTitle: "Built for spontaneous conversations, not public performance",
  ...
  fr: {
    ...
    heroTitle: "Rencontrez quelqu'un d'inattendu. Restez privé. Gardez le contrôle.",
    ...
    sectionsTitle: "Pensé pour des conversations spontanées, pas pour se mettre en scène",
  ...
  de: {
    ...
    heroTitle: "Triff jemanden Unerwarteten. Bleib privat. Behalte die Kontrolle.", heroLead: "Figgliz ist eine Chrome-Erweiterung für diskrete Eins-zu-eins-Gespräche mit zufällig gematchten Personen: Text, kurze Sprachnachrichten, optionale Webcam und kleine Spiele, ohne öffentliche Profile oder sozialen Druck.", heroKicker: "Private soziale Entdeckung", primaryCta: "Extension installieren", secondaryCta: "Tarife ansehen", betaNote: "Figgliz befindet sich derzeit im Betatest mit freiwilligen Nutzern vor der öffentlichen Veröffentlichung im Chrome Web Store.",
    sectionsTitle: "Für spontane Gespräche gebaut, nicht für öffentliche Selbstdarstellung", sectionsLead: "Figgliz hält Interaktionen direkt, leicht und minimal: kein öffentlicher Feed, keine Follower, kein Profiltheater.",
