...
const langs = {
  en: {
    ...
    demoLead: "Explore the real Ultimate Clipboard Pro interface mounted on this page with a secure demo data bridge. It is visual only: capture, copy, tools, settings, classification, deletion and paid workflows are disabled, but you can open the launcher, browse captures, search, reorder categories and switch versions.",
  ...
  fr: {
    ...
    demoLead: "Explorez la vraie interface Ultimate Clipboard Pro montée sur cette page avec un pont de données de démonstration sécurisé. Elle est uniquement visuelle : capture, copie, outils, paramètres, classement, suppression et workflows payants sont désactivés, mais vous pouvez ouvrir le launcher, parcourir les captures, rechercher, réordonner les catégories et changer de version.",
  ...
  es: {
    ...
    demoTitle: "Demo interactiva de Ultimate Clipboard Pro", demoDesc: "Prueba una demo visual de Ultimate Clipboard Pro con launcher flotante, panel lateral, gestor, categorías, versiones y capturas de ejemplo.", demoKicker: "Demo interactiva del producto", demoLead: "Explora la interfaz real de Ultimate Clipboard Pro montada en esta página con un puente seguro de datos de demostración. Es solo visual: captura, copia, herramientas, ajustes, clasificación, eliminación y flujos de pago están desactivados, pero puedes abrir el launcher, ver capturas, buscar, reordenar categorías y cambiar versiones.",
  ...
  it: {
    ...
    demoTitle: "Demo interattiva di Ultimate Clipboard Pro", demoDesc: "Prova una demo visiva di Ultimate Clipboard Pro con launcher flottante, pannello laterale, gestore, categorie, versioni e catture di esempio.", demoKicker: "Demo prodotto interattiva", demoLead: "Esplora la vera interfaccia Ultimate Clipboard Pro montata su questa pagina con un bridge sicuro di dati demo. È solo visiva: cattura, copia, strumenti, impostazioni, classificazione, eliminazione e flussi a pagamento sono disattivati, ma puoi aprire il launcher, sfogliare catture, cercare, riordinare categorie e cambiare versione.",
  ...
  de: {
    ...
    demoTitle: "Interaktive Demo von Ultimate Clipboard Pro", demoDesc: "Testen Sie eine visuelle Demo von Ultimate Clipboard Pro mit Floating Launcher, Seitenfenster, Manager, Kategorien, Versionen und Beispiel-Captures.", demoKicker: "Interaktive Produktdemo", demoLead: "Erkunden Sie die echte Ultimate Clipboard Pro Oberfläche, die auf dieser Seite mit einer sicheren Demo-Datenbrücke läuft. Sie ist rein visuell: Erfassen, Kopieren, Tools, Einstellungen, Klassifizierung, Löschen und Bezahlabläufe sind deaktiviert, aber Sie können den Launcher öffnen, Captures durchsuchen, suchen, Kategorien neu ordnen und Versionen wechseln.",
...
function staticProductPage(lang, page) {
  ...
  const main = page === "demo"
    ? `<section class="ucp-demo-intro"><article><h2>${esc(l.demoTitle)}</h2><p>${esc(l.demoLead)}</p><ul><li>${esc(l.demoBrowse || "Open the floating launcher and browse a realistic Pro workspace.")}</li><li>${esc(l.demoSafe || "Demo mode cannot capture, copy, open settings or run tools.")}</li><li>${esc(l.demoAllowed || "Click the floating buttons in the bottom-right corner to try the extension interface.")}</li></ul></article></section><div class="ucp-demo-root" data-ucp-demo-lang="${lang}"></div>`
    : page === "faq"
...
${page === "demo" ? '<link rel="stylesheet" href="/assets/ucp-demo.css?v=20260514-real-runtime">' : ""}
<script defer src="/assets/analytics.js"></script>
<script defer src="${productPagesScript}"></script>
<script defer src="/assets/install-extension-modal.js"></script>
${page === "demo" ? '<script defer src="/assets/ucp-demo.js?v=20260514-real-runtime"></script>' : ""}
</head>
